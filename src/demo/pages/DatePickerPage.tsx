...
export default function DatePickerPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="mb-2 text-display-sm font-bold">Date Picker</h1>
        <p className="text-body-md text-[var(--accu-gray-5)]">Date picker input and calendar grid aligned to the Figma day-cell states.</p>
      </div>
      ...
      <section className="grid gap-5 rounded-[var(--accu-radius-md)] border border-[var(--accu-gray-2)] bg-[var(--accu-white)] p-[var(--accu-space-6)] lg:grid-cols-2">
        <div>
          <h2 className="mb-3 text-body-sm font-bold uppercase text-[var(--accu-gray-4)]">Default</h2>
          <DatePicker value={date} onChange={setDate} label="Start Date" />
        </div>

        <div>
          <h2 className="mb-3 text-body-sm font-bold uppercase text-[var(--accu-gray-4)]">Pre-selected</h2>
        ...
        <div>
          <h2 className="mb-3 text-body-sm font-bold uppercase text-[var(--accu-gray-4)]">Disabled</h2>
