...
export default function ColorPickerPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="mb-2 text-display-sm font-bold">Color Picker</h1>
      ...
      <section className="grid gap-8 rounded-[var(--accu-radius-md)] border border-[var(--accu-gray-2)] bg-[var(--accu-white)] p-[var(--accu-space-6)] lg:grid-cols-2">
        <div>
          <h2 className="mb-3 text-body-sm font-bold uppercase text-[var(--accu-gray-4)]">Default (30 Swatches)</h2>
          <ColorPicker value={swatchValue} onChange={setSwatchValue} />
          <p className="mt-2 text-body-sm text-[var(--accu-gray-5)]">
            Selected: <span className="font-bold">{swatchValue}</span>
          </p>
        </div>

        <div>
          <h2 className="mb-3 text-body-sm font-bold uppercase text-[var(--accu-gray-4)]">Custom Color Mode</h2>
          <p className="mb-2 text-body-sm text-[var(--accu-gray-5)]">
