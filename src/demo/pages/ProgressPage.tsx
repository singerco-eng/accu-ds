...
export default function ProgressPage() {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="mb-2 accu-text-display-sm font-bold">Progress</h1>
        <p className="accu-text-body-md text-[var(--accu-gray-5)]">Horizontal progress bars and step meter variants.</p>
      </div>
      ...
      <section className="space-y-4 rounded-[var(--accu-radius-md)] border border-[var(--accu-gray-2)] bg-[var(--accu-white)] p-[var(--accu-space-6)]">
        <h2 className="accu-text-body-sm font-bold uppercase text-[var(--accu-gray-4)]">Progress Bar</h2>
      ...
      <section className="space-y-4 rounded-[var(--accu-radius-md)] border border-[var(--accu-gray-2)] bg-[var(--accu-white)] p-[var(--accu-space-6)]">
        <h2 className="accu-text-body-sm font-bold uppercase text-[var(--accu-gray-4)]">Progress Steps</h2>
